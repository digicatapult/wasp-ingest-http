...
*/}}
{{- define "wasp-ingest-http.fullname" -}}
...
Selector labels
*/}}
{{- define "wasp-ingest-http.selectorLabels" -}}
app.kubernetes.io/name: {{ include "wasp-ingest-http.fullname" . }}
{{- end }}

{{/*
Common labels
*/}}
{{- define "wasp-ingest-http.labels" -}}
helm.sh/chart: {{ include "wasp-ingest-http.chart" . }}
{{ include "wasp-ingest-http.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "wasp-ingest-http.imagePullSecrets" -}}
...
*/}}
{{- define "wasp-ingest-http.kafka.brokers" -}}
...
*/}}
{{- define "wasp-ingest-http.thingServiceName" -}}
...
*/}}
{{- define "wasp-ingest-http.initContainers" }}
initContainers:
{{ $name := include "wasp-ingest-http.fullname" . }}
  - name: {{ printf "%s-wait-deps" $name | trunc 63 | trimSuffix "-" }}
    ...
    env:
      - name: THING_NAME
        value: {{ include "wasp-ingest-http.thingServiceName" . }}
